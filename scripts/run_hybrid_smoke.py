"""Optional local smoke run for real BM25 plus dense reciprocal-rank fusion."""
...
DEFAULT_CASE_ID = "pricing_procurement_010"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one real BM25+dense reciprocal-rank-fusion trace over the synthetic corpus."
    )
...
def main() -> None:
    ...
    trace = HybridRetriever(
        ...
        rrf_k=args.rrf_k,
    ).retrieve(case=case, top_k=args.top_k)
